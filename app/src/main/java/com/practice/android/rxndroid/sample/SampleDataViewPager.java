package com.practice.android.rxndroid.sample;
...
public class SampleDataViewPager {
    public final static List<Product> productList = new ArrayList<>();
    public final static Map<String, Product> productMap = new HashMap<>();
    ...
    public static List<String> getProudctNames() {
